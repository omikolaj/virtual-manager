...
Employee.create(name: "Mark Zuckerberg", manager: false, email: "mark.zuckerberg@gmail.com", password: "password", dealership_id: 2, permission: 20)
Employee.create(name: "Ada Lovelace", manager: false, email: "ada.lovelace@gmail.com", password: "password", dealership_id: 3, permission: 20)
Employee.create(name: "Steve Wozniak", manager: false, email: "steve.wozniak@gmail.com", password: "password", dealership_id: 4, permission: 20)
Employee.create(name: "John Carmack", manager: false, email: "john.carmack@gmail.com", password: "password", dealership_id: 5, permission: 20)
Employee.create(name: "Donald Knuth", manager: false, email: "donald.knuth@gmail.com", password: "password", dealership_id: 6, permission: 20)
...
Employee.create(name: "Richard Stallman", manager: false, email: "richard.stallman@gmail.com", password: "password", dealership_id: 1, permission: 20)
Employee.create(name: "James Gosling", manager: false, email: "james.gosling@gmail.com", password: "password", dealership_id: 3, permission: 20)
Employee.create(name: "Ken Thompson", manager: false, email: "ken.thompson@gmail.com", password: "password", dealership_id: 4, permission: 20)
Employee.create(name: "Bjarne Stroustrup", manager: false, email: "bjarne.stroustrup@gmail.com", password: "password", dealership_id: 5, permission: 20)
Employee.create(name: "Larry Wall", manager: false, email: "larry.wall@gmail.com", password: "password", dealership_id: 6, permission: 20)
...
Employee.create(name: "Guido van Rossum", manager: false, email: "guido.vanRossum@gmail.com", password: "password", dealership_id: 2, permission: 20)
Employee.create(name: "Paul Allen", manager: false, email: "paul.allen@gmail.com", password: "password", dealership_id: 1, permission: 20)
Employee.create(name: "Brian Kernighan", manager: false, email: "brian.kernighan@gmail.com", password: "password", dealership_id: 4, permission: 20)
Employee.create(name: "Andres Hejsberg", manager: false, email: "andres.hejsberg@gmail.com", password: "password", dealership_id: 5, permission: 20)
Employee.create(name: "Bram Cohen", manager: false, email: "bram.cohen@gmail.com", password: "password", dealership_id: 6, permission: 20)
Employee.create(name: "Jack Dorsey", manager: false, email: "jack.dorsey@gmail.com", password: "password", dealership_id: 1, permission: 20)
Employee.create(name: "Yukihiro Matsumoto", manager: false, email: "yukihiro.matsumoto@gmail.com", password: "password", dealership_id: 2, permission: 20)
