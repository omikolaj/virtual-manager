...
Vehicle.create(make: "Volkswage", model: "Beetle", year: 2016, dealership_vehicle_id: 5)
Vehicle.create(make: "Volkswage", model: "Caddy", year: 2010, dealership_vehicle_id: 6)
Vehicle.create(make: "Volkswage", model: "Passat", year: 2010, dealership_vehicle_id: 7)
Vehicle.create(make: "Volkswage", model: "Tiguan", year: 2010, dealership_vehicle_id: 8)
